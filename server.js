...
app.use(
  session({
    ...
    // activate the below when using mongoose
...
// The flash middleware let's us use req.flash('error', 'Oh No's!'),
...
// If that above routes didnt work, we 404 them and forward to error helper
app.use(errorHelpers.notFound);

// One of our error handlers will see if these errors are just validation errors
app.use(errorHelpers.flashValidationErrors);
